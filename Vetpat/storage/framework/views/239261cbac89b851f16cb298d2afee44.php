        ...
        <div class="row">
            <div class="col-md-6">
                <?php if($producto->imagen): ?>
                    <img src="<?php echo e(asset('storage/imagenes_productos/' . $producto->imagen)); ?>" class="img-fluid"
            ...
            <div class="col-md-6">
                ...
                <p><strong>Precio:</strong> Bs <?php echo e(number_format($producto->precio, 2)); ?></p>
